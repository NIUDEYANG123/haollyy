...
public class Coupon2ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    //自宝义构造
    public Coupon2ExpandableListAdapter(Context context, List<AccountCouponbean.ModelBean.CouponReceiveListBean> couponReceiveListBeans) {
    ...
    public View getGroupView(int groupPosition, boolean flag, View convertView, ViewGroup viewgroup) {
        ...
        if (convertView == null) { //判断view（即view是否已构建好）是否为空
            ...
            convertView = mGroupInflater.inflate(R.layout.item_expandable_group_coupon2, null);
