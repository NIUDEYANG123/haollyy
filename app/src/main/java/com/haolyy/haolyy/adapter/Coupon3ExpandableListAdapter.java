...
public class Coupon3ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    //自宝义构造
    public Coupon3ExpandableListAdapter(Context context, List<AccountCouponbean.ModelBean.CouponReceiveListBean> couponReceiveListBeans) {
    ...
    public Object getChild(int groupPosition, int j) {
        return couponReceiveListBeans.get(groupPosition).getDeliveryRangeProduct();
    }
    ...
    public View getGroupView(int groupPosition, boolean flag, View convertView, ViewGroup viewgroup) {
        ...
        if (convertView == null) { //判断view（即view是否已构建好）是否为空
            ...
            convertView = mGroupInflater.inflate(R.layout.item_expandable_group_coupon3, null);
