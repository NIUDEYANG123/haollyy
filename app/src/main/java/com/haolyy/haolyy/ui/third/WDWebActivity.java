 ...
 * 汇付提现
 */
public class WDWebActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        webSh.addJavascriptInterface(new JavaScriptInterface(WDWebActivity.this), "Android");//MyBrowserAPI:自定义的js函数名
