...
import com.haolyy.haolyy.utils.AndroidBug5497Workaround;
 ...
 * 开户激活web页
 */
public class ShWebActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        AndroidBug5497Workaround.assistActivity(this);//解决全屏模式下，webview软键盘遮挡的问题
        ...
        webSh.addJavascriptInterface(new JavaScriptInterface(ShWebActivity.this), "Android");//MyBrowserAPI:自定义的js函数名
