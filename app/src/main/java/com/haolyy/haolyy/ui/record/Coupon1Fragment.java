...
import com.haolyy.haolyy.adapter.Coupon1ExpandableListAdapter;
...
public class Coupon1Fragment extends BaseFragment<CardQuanPresenter, CardQuanView> implements CardQuanView {
    ...
    private View view;
    // 声明对象
    private Coupon1ExpandableListAdapter adapter = null;
    private List<AccountCouponbean.ModelBean.CouponReceiveListBean> listall;
    private List<AccountCouponbean.ModelBean.CouponReceiveListBean> listunuse;
    ...
    private void init() {
        ...
        expandableId.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            ...
            public boolean onGroupClick(ExpandableListView expandableListView, View view, int i, long l) {
                ...
                adapter.setOnChangeImgCallBack(new Coupon1ExpandableListAdapter.OnChangeImgCallBack() {
                    @Override
    ...
    public void showCoupons(AccountCouponbean accountCouponbean) {
        ...
        if (accountCouponbean.getModel().getCouponReceiveList().size() > 0) {
            ...
            if (listunuse.size() > 0) {
                ...
                adapter = new Coupon1ExpandableListAdapter(mContext, listunuse);
                // 设置适配器
